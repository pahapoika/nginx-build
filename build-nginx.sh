...
export VERSION_LIBRESSL=libressl-2.8.2
export VERSION_NGINX=nginx-1.15.6
...
export SHA256_NGINX=a3d8c67c2035808c7c0d475fffe263db8c353b11521aa7ade468b780ed826cc6
export SHA256_LIBRESSL=b8cb31e59f1294557bfc80f2a662969bc064e83006ceef0574e2553a1c254fd5
...
curl -L $SOURCE_LIBRESSL$VERSION_LIBRESSL.tar.gz -o $BPATH/LIBRESSL.tar.gz && \
  echo "${SHA256_LIBRESSL} $BPATH/LIBRESSL.tar.gz" | sha256sum -c -  
